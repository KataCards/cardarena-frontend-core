...
/**
 * LoginPresenter - The "Skin" for the Login Page.
 * Responsible for the visual structure and interactivity of the login form.
 */
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                id="username"
                type="text"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors disabled:bg-gray-50 disabled:text-gray-500 outline-none"
                value={username}
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-red-600 text-white py-3 px-4 rounded-lg hover:bg-red-700 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:bg-red-400 disabled:cursor-not-allowed transition-all duration-200 font-semibold flex items-center justify-center space-x-2 shadow-sm"
            >
              {isLoading ? (
                <>
